...
namespace BBTB.States
{
    public class GameState : State
    {
        ...
        public GameState(Game1 game, GraphicsDevice graphicsDevice, ContentManager Content) : base(game, graphicsDevice, Content)
        {
            ...
            {
                { "FrontWalk", new Animation(Content.Load<Texture2D>("CharacterAnimation/FrontWalk"), 8) },
                { "BackWalk", new Animation(Content.Load<Texture2D>("CharacterAnimation/BackWalk"), 8) },
                { "RightWalk", new Animation(Content.Load<Texture2D>("CharacterAnimation/RightWalk"), 8) },
                { "LeftWalk", new Animation(Content.Load<Texture2D>("CharacterAnimation/LeftWalk"), 8) }
            };
            _sprites = new List<Sprites.Sprites>()
            {
                new Sprites.Sprites(animations)
                {
            ...
            _board = new Board(_spriteBatch, tileTexture, tileTexture2, tileTexture3, monsterTexture, 15, 10, _player, this);
